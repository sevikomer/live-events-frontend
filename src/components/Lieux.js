    ...
    <>
      ...
      <div className='grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1'>
        <div className='m-10 p-5 flex flex-col border border-solid border-black rounded-md'>
          <h2 className='text-center text-xl font-bold leading-9 tracking-tight text-black'>Ajouter un lieu</h2>
        ...
        <div className='col-span-2 m-10 p-5 border border-solid border-black rounded-md'>
          <h2 className='text-center text-xl font-bold leading-9 tracking-tight text-black'>Liste des lieux</h2>
